 ...
 * Run with: node scripts/run-create-insan-fund.js
 */
...
async function createInsanFund() {
  ...
  try {
    ...
    if (selectError) {
      console.error("❌ Error verifying funds:", selectError.message)
      throw selectError
    }
    ...
    console.error("❌ Failed to create Insan fund:", error.message)
    throw error
  }
}
